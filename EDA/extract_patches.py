...
SUBSET = args.subset
SAVE_IMG = args.img
MASK_DIMS = tuple([int(PATCH_DIM/2)])*3 #set the width, height, depth of mask
...
for fcount, img_file in enumerate(tqdm(file_list)):
	...
	for candidate_idx, cur_row in mini_df.iterrows(): # Iterate through all candidates
		...
		# NOT SAVINGIMGS RIGHT NOW --uncomment out to run
		# if SAVE_IMG:
		# 	imsave(PATCH_DIR + "class_{}_id_{}_xyz_{}_{}_{}.png".format(
		# 		class_id,
		# 		seriesuid,
		# 		candidate_x,
		# 		candidate_y,
