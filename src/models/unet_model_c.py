...
CHECKPOINT_FILENAME = "./cnn_3DUNET_ModelC_exp1_lr009_BSexp1_64_64_64_HOLDOUT{}".format(HOLDOUT_SUBSET) + time.strftime("_%Y%m%d_%H%M%S") + ".hdf5"
...
with h5py.File(path_to_hdf5, 'r') as hdf5_file: # open in read-only mode
	...
	model.save('UNET_modelC_exp1_lr009_BSexp1_H{}.h5'.format(HOLDOUT_SUBSET))
	model.save_weights('UNET_weights_modelC_exp1_lr009_BSexp1_H{}.h5'.format(HOLDOUT_SUBSET))
